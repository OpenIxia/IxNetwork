...
################################################################################
# Configure DHCP Hosts over L2TP		                                       #
################################################################################
puts "Configure DHCP Hosts over L2TP ..."
update idletasks
...
set dhcp6_pd_client_range_use_vendor_class_id         1
...
set dsppp_status_client [::ixia::l2tp_config                                                                  \
        -port_handle                                       $port_0                                            \
        -l2_encap                                          $l2_encap                                          \
        ...
        -dhcp6_pd_client_range_duid_type                   $dhcp6_pd_client_range_duid_type                   \
        -dhcp6_pd_client_range_ia_id                       $dhcp6_pd_client_range_ia_id                       \
        -dhcp6_pd_client_range_ia_t1                       $dhcp6_pd_client_range_ia_t1                       \
        -dhcp6_pd_client_range_duid_enterprise_id          $dhcp6_pd_client_range_duid_enterprise_id          \
        -dhcp6_pd_client_range_duid_vendor_id              $dhcp6_pd_client_range_duid_vendor_id              \
        -dhcp6_pd_client_range_duid_vendor_id_increment    $dhcp6_pd_client_range_duid_vendor_id_increment    \
        -dhcp6_pd_client_range_ia_t2                       $dhcp6_pd_client_range_ia_t2                       \
        -dhcp6_pd_client_range_param_request_list          $dhcp6_pd_client_range_param_request_list          \
        -dhcp6_pd_client_range_renew_timer                 $dhcp6_pd_client_range_renew_timer                 \
        -dhcp6_pd_client_range_use_vendor_class_id         $dhcp6_pd_client_range_use_vendor_class_id         \
        ...
        -dhcp6_global_echo_ia_info                         $dhcp6_global_echo_ia_info                         \
        -dhcp6_global_max_outstanding_releases             $dhcp6_global_max_outstanding_releases             \
        -dhcp6_global_max_outstanding_requests             $dhcp6_global_max_outstanding_requests             \
        -dhcp6_global_reb_max_rt                           $dhcp6_global_reb_max_rt                           \
        -dhcp6_global_reb_timeout                          $dhcp6_global_reb_timeout                          \
        -dhcp6_global_rel_max_rc                           $dhcp6_global_rel_max_rc                           \
        -dhcp6_global_rel_timeout                          $dhcp6_global_rel_timeout                          \
        -dhcp6_global_ren_max_rt                           $dhcp6_global_ren_max_rt                           \
        -dhcp6_global_ren_timeout                          $dhcp6_global_ren_timeout                          \
        -dhcp6_global_req_max_rc                           $dhcp6_global_req_max_rc                           \
        -dhcp6_global_req_max_rt                           $dhcp6_global_req_max_rt                           \
        -dhcp6_global_req_timeout                          $dhcp6_global_req_timeout                          \
        -dhcp6_global_sol_max_rc                           $dhcp6_global_sol_max_rc                           \
        -dhcp6_global_sol_max_rt                           $dhcp6_global_sol_max_rt                           \
        -dhcp6_global_sol_timeout                          $dhcp6_global_sol_timeout                          \
        ...
        -dhcp6_global_teardown_rate_increment              $dhcp6_global_teardown_rate_increment              \
        -dhcp6_global_teardown_rate_initial                $dhcp6_global_teardown_rate_initial                \
        -dhcp6_global_teardown_rate_max                    $dhcp6_global_teardown_rate_max                    \
        -dhcp6_global_wait_for_completion                  $dhcp6_global_wait_for_completion                  \
    ]
...
set dhcp6_pd_server_range_start_pool_address            2201::
set dhcp6_pd_server_range_subnet_prefix                 64
set dhcp6_pd_server_range_first_dns_server              20:0:2::2
set dhcp6_pd_server_range_second_dns_server             20:0:2::3
set dhcp6_pd_server_range_dns_domain_search_list        ixia.com
...
set dsppp_status_server [::ixia::l2tp_config                                                                  \
        -port_handle                                       $port_1                                            \
        -l2_encap                                          $l2_encap                                          \
        -l2tp_dst_addr                                     $l2tp_dst_addr                                     \
        -l2tp_src_addr                                     $l2tp_src_addr                                     \
        ...
        -dhcp6_pd_server_range_first_dns_server            $dhcp6_pd_server_range_first_dns_server            \
        -dhcp6_pd_server_range_second_dns_server           $dhcp6_pd_server_range_second_dns_server           \
        -dhcp6_pd_server_range_dns_domain_search_list      $dhcp6_pd_server_range_dns_domain_search_list      \
        -dhcp6_pgdata_max_outstanding_releases             $dhcp6_pgdata_max_outstanding_releases             \
        -dhcp6_pgdata_max_outstanding_requests             $dhcp6_pgdata_max_outstanding_requests             \
        -dhcp6_pgdata_override_global_setup_rate           $dhcp6_pgdata_override_global_setup_rate           \
        -dhcp6_pgdata_override_global_teardown_rate        $dhcp6_pgdata_override_global_teardown_rate        \
...
set control_handle [list $dsppp_handle_server $dsppp_handle_client]
...
set l2tp_stats_status [::ixia::l2tp_stats   \
        -mode           aggregate           \
        -port_handle    $port_handle        \
    ]
if {[keylget l2tp_stats_status status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget l2tp_stats_status log]"
    return 0
}
set stats [keylprint l2tp_stats_status]
puts "$stats"


if {[keylget l2tp_stats_status $port_0.aggregate.dhcpv6pd_sessions_succeeded] != 5} {
	puts "FAIL - $test_name - only [keylget l2tp_stats_status $port_0.aggregate.dhcpv6pd_sessions_succeeded] from 5 "
	return 0}
