...
set sess_num       [keylget aggr_status ${port_handle}.aggregate.num_sessions]
set sess_count_up  [keylget aggr_status ${port_handle}.aggregate.connected]
set sess_min_setup [keylget aggr_status ${port_handle}.aggregate.min_setup_time]
set sess_max_setup [keylget aggr_status ${port_handle}.aggregate.max_setup_time]
set sess_avg_setup [keylget aggr_status ${port_handle}.aggregate.avg_setup_time]
