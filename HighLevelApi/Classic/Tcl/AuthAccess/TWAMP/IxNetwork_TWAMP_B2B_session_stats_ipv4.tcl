...
#                                                                              #
#    It configures two IPv4 Ethernet interfaces and configures TWAMP on each   #
#    port. TWAMP is started and some statistics are gathered.                  #
#                                                                              #
# Module:                                                                      #
...
set interface_config_handle_1_list   [keylget interface_status interface_handle]
...
foreach interface_config_handle_0 $interface_config_handle_0_list {
    ...
    set TWAMP_control_range_config_status [::ixia::emulation_twamp_control_range_config  \
            ...
            -key_id                               second_key                             \
            -server_ip                            198.10.1.1                             \
            -server_ip_intra_range_step           0.0.0.1                                \
            -server_port                          862                                    \
...
foreach interface_config_handle_1 $interface_config_handle_1_list {
    ...
    set TWAMP_server_range_config_status [::ixia::emulation_twamp_server_range_config    \
            ...
            -key_id                                  second_key                          \
            -permitted_ip                            198.10.0.1                          \
            -permitted_ip_intra_range_step           0.0.0.1                             \
            -permitted_pkt_size                      64                                  \
            -permitted_sender_port                   11001                               \
            -permitted_timeout                       1                                   \
            -reflector_port                          12001                               \
...
set current_index 0
foreach interface_config_handle_0 $interface_config_handle_0_list {
    set twamp_control_range_reference [lindex $TWAMP_control_range_handles $current_index]
    incr current_index
    # Start TWAMP Call
    set TWAMP_test_range_config_status [::ixia::emulation_twamp_test_range_config        \
            -mode                                  create                                \
            -control_range_handle                  $twamp_control_range_reference        \
            -handle                                $interface_config_handle_0            \
            -num_pkts                              10                                    \
            -padding_with_zero                     0                                     \
            -pkt_length                            64                                    \
            -pps                                   5                                     \
            -session_reflector_port                12001                                 \
            -session_reflector_port_step           0                                     \
            -session_sender_port                   11001                                 \
            -session_sender_port_step              0                                     \
    ...
    puts "Ixia TWAMP test handles are: "
    update idletasks
