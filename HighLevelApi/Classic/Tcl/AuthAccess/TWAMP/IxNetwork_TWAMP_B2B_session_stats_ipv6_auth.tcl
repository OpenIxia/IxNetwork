...
#                                                                              #
#    It configures two IPv6 Ethernet interfaces and configures TWAMP on each   #
#    port. TWAMP is started and statistics are gathered.                       #
#                                                                              #
# Module:                                                                      #
...
foreach interface_config_handle_1 $interface_config_handle_1_list {
    ...
    set TWAMP_server_range_config_status [::ixia::emulation_twamp_server_range_config    \
            ...
            -key_id                                  second_key                          \
            -permitted_ip                            100::3                              \
            -permitted_ip_intra_range_step           0::0                                \
