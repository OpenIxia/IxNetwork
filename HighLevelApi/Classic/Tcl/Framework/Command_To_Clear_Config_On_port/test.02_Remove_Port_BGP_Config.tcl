...
#                                                                              #
# Description:                                                                 #
#    This sample configures Port Interfaces, OSPF, BGP protocol and traffic    #
#    on the port and remove the BGP protocol config on the port                #
# Module:                                                                      #
...
set src_handle [lindex $bgp_route_range_port_0 0]
puts "SRC: $src_handle"
set dst_handle [lindex $bgp_route_range_port_1 0]
puts "DST: $dst_handle"
set traffic_status [::ixia::traffic_config                                       \
            -traffic_generator                   ixnetwork_540                   \
