...
#                                                                              #
# Description:                                                                 #
#    This sample creates PIM routers and adds multicast groups and sources to  #
#    the routers.  The key to this sample is that it is using the interface    #
#    handle from interface_config in the call to emulation_pim_config.         #
#                                                                              #
# Module:                                                                      #
