...
#    It configures one IPv4 Ethernet interface on each port and creates        #
#    a traffic item with two egress tracking elements. After this, it modifies #
#    the traffic item in order to disable the egress tracking.                 #
#                                                                              #
# Module:                                                                      #
...
# Configure one traffic item with two egressTracking elements
# which are set to dscp and tos_precedence
set traffic_status [::ixia::traffic_config                                     \
    ...
    -rate_percent               10                                             \
    -egress_tracking            tos_precedence dscp                            \
...
# Disable egress tracking feature on the current traffic item
