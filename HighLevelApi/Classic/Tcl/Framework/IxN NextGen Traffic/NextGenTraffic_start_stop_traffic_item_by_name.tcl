...
set chassis_ip                  ixro-hlt-xm2-02
set tcl_server                  ixro-hlt-xm2-02
...
set stream_id1 [keylget traffic_result stream_id]
...
if {[keylget traffic_result2 status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget traffic_result2 log]"
    return 0
}
...
set stream_id2 [keylget traffic_result2 stream_id]

set titem_1 {::ixNet::OBJ-/traffic/trafficItem:1}
set titem_2 {::ixNet::OBJ-/traffic/trafficItem:2}

set traffic_item [keylget traffic_result stream_id]
set traffic_item2 [keylget traffic_result2 stream_id]

set run_traffic [::ixia::traffic_control    \
    -action  run                            \
    -handle  [list $traffic_item $traffic_item2]                  \
    ]
if {[keylget run_traffic status] != $::SUCCESS} {
    puts "error in traffic_control: [keylget run_traffic log]"
    return 0
}
