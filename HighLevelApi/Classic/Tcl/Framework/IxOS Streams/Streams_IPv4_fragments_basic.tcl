...
#                                                                              #
# Description:                                                                 #
#    This sample get fragments statistics.                                     #
#                                                                              #
# Module:                                                                      #
...
set port_handle [lindex $port_handle_list 0]
set port_stat   [lindex $port_handle_list 1]
...
set retCode [::ixia::traffic_control                     \
        -port_handle        $port_stat      \
        -action             clear_stats]     
...
set retCode [::ixia::traffic_stats             \
        -port_handle        $port_stat \
        -mode aggregate]
if {[keylget retCode status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget traffic_status log]"
...
puts "fragments_rate [keylget retCode $port_stat.aggregate.rx.fragments_rate]"
puts "fragments_count [keylget retCode $port_stat.aggregate.rx.fragments_count]"
