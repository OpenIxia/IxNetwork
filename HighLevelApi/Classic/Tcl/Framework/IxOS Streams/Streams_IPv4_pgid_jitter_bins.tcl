...
#    using an UDF. Jitter statistics are displayed for each packet group id.   #
#                                                                              #
# Module:                                                                      #
...
puts  [format "%8s  %8s  %15s  %15s  %8s  %8s  %8s" \
        PGID Bin# FirstTS LastTS MaxJ MinJ TotalPackets]
...
puts  [format "%8d  %8d  %15.1f  %15.1f  %8.1f  %8.1f  %8d"             \
        ...
        $port_handle_rx.pgid.$pgid_index.rx.jitter_bin.$l.first_tstamp] \
        [keylget pgid_statistics_list \
        $port_handle_rx.pgid.$pgid_index.rx.jitter_bin.$l.last_tstamp]  \
        [keylget pgid_statistics_list \
        $port_handle_rx.pgid.$pgid_index.rx.jitter_bin.$l.max]          \
        [keylget pgid_statistics_list \
        $port_handle_rx.pgid.$pgid_index.rx.jitter_bin.$l.min]          \
        [keylget pgid_statistics_list \
        $port_handle_rx.pgid.$pgid_index.rx.jitter_bin.$l.total_pkts]   \
        [keylget pgid_statistics_list ]]
    }
}
