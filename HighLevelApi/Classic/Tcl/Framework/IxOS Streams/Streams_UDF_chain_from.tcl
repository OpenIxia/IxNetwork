...
#                                                                              #
# Description:                                                                 #
#    This sample create a L2 stream.                                           #
#                                                                              #
# Module:                                                                      #
...
# udf1 offset should be >= 54 to prevent of overwrite arp/ip header
set traffic_status [::ixia::traffic_config             \
        -mode                       create             \
        -port_handle                $port_handle       \
        -ip_src_addr                12.1.3.2           \
        -ip_dst_addr                22.1.3.2           \
        -l3_length                  70                 \
        -rate_percent               89                 \
        -enable_udf1                1                  \
        -udf1_mode                  counter            \
        -udf1_counter_repeat_count  10                 \
        -udf1_offset                54                 \
        -udf1_chain_from            udf3               \
        -enable_udf2                1                  \
        -udf2_mode                  counter            \
        -udf2_offset                55                 \
        -udf2_counter_repeat_count  100                \
        -enable_udf3                1                  \
        -udf3_mode                  counter            \
        -udf3_offset                56                 \
        -udf3_counter_repeat_count  100                \
        -udf3_chain_from            udf2               \
