...
#                                                                              #
# Description:                                                                 #
#    This sample configures 4 Ixia ports using auto feature for speed and      #
# duplex.                                                                      #
#                                                                              #
# Module:                                                                      #
...
set port_list [list 1/1 1/2 1/3 1/4]
...
set mode_list         ""
set speed_list        [list auto ether10 ether100 ether1000]
set duplex_list       ""
set auto_list         ""
set phy_mode_list     ""

#set duplex_list [list auto half full half]

for {set i 0} {$i < 4} {incr i} {
    lappend port_handle_list         [lindex $port_handle $i]
    lappend phy_mode_list            copper
    lappend auto_list                1
    lappend mode_list                config
...
if {[keylget interface_status status] != $::SUCCESS} {
    return "FAIL - $testname - [keylget interface_status log]"
}
