...
#                                                                              #
# Description:                                                                 #
#    This sample creates multiple IPv4 streams with different IP TOS values.   #
#                                                                              #
# Module:                                                                      #
...
set ip_tos_list       "0   1  2  3  4  5  6  7"
set dscp_options      "0   1 10 19 36 29 46 63"
set traffic_rate_list "30 10 15 10 15 10  5  5"
set ip_dest_octet     2
set index             0
set stream_index_list ""

foreach ip_tos $ip_tos_list dscp_opt $dscp_options {

    set traffic_rate [lindex $traffic_rate_list $index]
    ...
    set traffic_status1 [::ixia::traffic_config                \
            ...
            -ip_dst_addr  12.1.1.$ip_dest_octet              \
            -l3_length    1466                               \
            -ip_dscp      $dscp_opt                          \
            -name         "TOS - $ip_tos"                    \
            -rate_percent [lindex $traffic_rate_list $index] \
    ...
    lappend stream_index_list $stream_index
}
