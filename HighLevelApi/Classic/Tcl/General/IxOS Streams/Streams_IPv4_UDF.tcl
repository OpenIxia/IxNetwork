...
#                                                                              #
# Description:                                                                 #
#    This sample configures an IPv4 stream with five UDFs.                     #
#                                                                              #
# Module:                                                                      #
...
set traffic_status [::ixia::traffic_config        \
        ...
        -enable_udf1                1           \
        -udf1_mode                  range_list  \
        -udf1_counter_type          32          \
        -udf1_enable_cascade        0           \
        -udf1_counter_init_value    "0xA1B1C1D1  0x1111" \
        -udf1_counter_repeat_count  "10  20"    \
        -udf1_counter_step          "2  5"      \
        -udf1_offset                40          \
        -enable_udf2                1           \
        -udf2_mode                  random      \
        -udf2_offset                44          \
        -udf2_counter_type          16          \
        -udf2_mask_select           0x00ff      \
        -udf2_mask_val              0x0005      \
        -enable_udf3                1           \
        -udf3_mode                  value_list  \
        -udf3_offset                30          \
        -udf3_counter_type          16          \
        -udf3_value_list            "0x000a 0x000b" \
        -enable_udf4                1           \
        -udf4_mode                  nested      \
        -udf4_offset                44          \
        -udf4_counter_type          16          \
        -udf4_counter_init_value    11          \
        -udf4_counter_repeat_count  10          \
        -udf4_counter_step          5           \
        -udf4_inner_repeat_value    11          \
        -udf4_inner_step            12          \
        -udf4_inner_repeat_count    13          \
        -enable_udf5                1           \
        -udf5_mode                  ipv4        \
        -udf5_offset                33          \
        -udf5_counter_type          32          \
        -udf5_counter_repeat_count  10          \
        -udf5_counter_init_value    0x01010a0c  \
        -udf5_inner_repeat_value    21          \
        -udf5_inner_step            22          \
        -udf5_skip_zeros_and_ones   1           \
        -udf5_skip_mask_bits        6           \
         ]
if {[keylget traffic_status status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget traffic_status log]"
}
