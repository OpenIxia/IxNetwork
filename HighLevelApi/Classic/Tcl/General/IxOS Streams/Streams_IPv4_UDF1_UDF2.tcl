...
#                                                                              #
# Description:                                                                 #
#    This sample configures an IPv4 stream with two UDFs.                      #
#                                                                              #
# Module:                                                                      #
...
set traffic_status [::ixia::traffic_config        \
        ...
        -udf1_mode                 counter      \
        -udf1_offset               40           \
        -udf1_counter_type         16           \
        -udf1_counter_up_down      up           \
        -udf1_counter_init_value   11           \
        -udf1_counter_repeat_count 666          \
        -udf1_counter_step         2            \
        ...
        -udf2_counter_up_down      up           \
        -udf2_counter_init_value   11           \
        -udf2_counter_repeat_count 666          \
        -udf2_counter_step         2            \
        -udf2_counter_mode         count        ]
if {[keylget traffic_status status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget traffic_status log]"
}
