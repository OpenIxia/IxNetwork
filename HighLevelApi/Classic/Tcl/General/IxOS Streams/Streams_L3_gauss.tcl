...
# Description:                                                                 #
#                                                                              #
#     This sample creates a stream with a framesize that has gaussian          #
#     distribution (there can be up to 4 gaussian curves specified) and        #
#     then modifies one of the gaussian curves for that stream.                #
#                                                                              #
# Module:                                                                      #
...
set traffic_status [::ixia::traffic_config \
        ...
        -length_mode     gaussian          \
        -l3_length_min   100               \
        -l3_length_max   1000              \
        -l3_gaus1_avg    256.0             \
        -l3_gaus1_halfbw 128.0             \
        -l3_gaus1_weight 1                 \
        -l3_gaus2_avg    512.0             \
        -l3_gaus2_halfbw 256.0             \
        -l3_gaus2_weight 4                 \
        -l3_gaus3_avg    1028.0            \
        -l3_gaus3_halfbw 512.0             \
        -l3_gaus3_weight 8                 \
        -l3_gaus4_avg    1500.0            \
        -l3_gaus4_halfbw 12.0              \
        -l3_gaus4_weight 1                 \
        -rate_percent    50                \
...
# Modify stream
# Note:
#     In order to modify a gaussian/cuad curve the length_mode argument
#     and all three arguments: l3_gaus1_avg,l3_gaus1_halfbw, l3_gaus1_weight
#     for that curve must be provided.
# 
set traffic_status [::ixia::traffic_config \
        -mode            modify            \
        -port_handle     $port_handle      \
