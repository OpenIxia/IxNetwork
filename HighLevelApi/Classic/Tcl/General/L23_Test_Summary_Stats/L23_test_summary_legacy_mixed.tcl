...
#    The stats is calculated using mode l23_test_summary and measure_mode      #
#    legacy mixed                                                              #
# Module:                                                                      #
...
set run_traffic [::ixia::traffic_control -action run ]
...
#Getting stats using the GUI measure mode
set stats [::ixia::traffic_stats -mode l23_test_summary]
CheckFailure stats
keylprint $stats
