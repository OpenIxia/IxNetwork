...
#                                                                              #
# Description:                                                                 #
#    This sample connects to IxNetwork Tcl Proxy Server using virtual ports    #
#    and displays the proxy connection information.The IxNetwork Tcl           #
#    Proxy Server uses the first available free user to connect                #
# Module:                                                                      #
