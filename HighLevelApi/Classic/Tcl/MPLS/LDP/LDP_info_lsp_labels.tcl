...
#    information regarding the learned labels.                                 #
#                                                                              #
# Module:                                                                      #
...
puts "First router's learned labels:"
set ldp_perfixes        [keylget ldp_routers_info prefix]
set ldp_prefix_lengths  [keylget ldp_routers_info prefix_length]
set ldp_labels          [keylget ldp_routers_info label]
set ldp_sources         [keylget ldp_routers_info source]
set ldp_types           [keylget ldp_routers_info type]
set ldp_fec_types       [keylget ldp_routers_info fec_type]
set ldp_vc_ids          [keylget ldp_routers_info vc_id]
set ldp_vc_types        [keylget ldp_routers_info vc_type]
set ldp_group_ids       [keylget ldp_routers_info group_id]
set ldp_vcis            [keylget ldp_routers_info vci]
set ldp_vpis            [keylget ldp_routers_info vpi]
set ldp_states          [keylget ldp_routers_info state]
puts "Prefix\t\tPrefix length\tLabel\t\tSource\t\tType\t\tFEC Type\tVC\
        ID\t\tVC Type\t\tGroup ID\tVCI\t\tVPI\t\tState"
for {set i 0} {$i < [llength $ldp_perfixes]} {incr i} {
    puts "[lindex $ldp_perfixes $i]\t[lindex $ldp_prefix_lengths $i]\t\t[lindex\
            $ldp_labels $i]\t\t[lindex $ldp_sources $i]\t[lindex $ldp_types\
            $i]\t\t[lindex $ldp_fec_types $i]\t[lindex $ldp_vc_ids $i]\t\t[lindex\
            $ldp_vc_types $i]\t\t[lindex $ldp_group_ids $i]\t\t[lindex $ldp_vcis\
            $i]\t\t[lindex $ldp_vpis $i]\t\t[lindex $ldp_states $i]"
}
...
puts "Second router's learned labels:"
set ldp_perfixes        [keylget ldp_routers_info prefix]
set ldp_prefix_lengths  [keylget ldp_routers_info prefix_length]
set ldp_labels          [keylget ldp_routers_info label]
set ldp_sources         [keylget ldp_routers_info source]
