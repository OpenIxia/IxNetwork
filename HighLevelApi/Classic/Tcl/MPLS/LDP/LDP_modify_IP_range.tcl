...
set ldp_route_status [::ixia::emulation_ldp_route_config                       \
        ...
        -fec_vc_ip_range_addr_count        5                                   \
        -fec_vc_ip_range_addr_start        11.11.11.2                          \
...
set lsp_vc_ip_range_handles [keylget ldp_route_status lsp_vc_ip_range_handles]
...
set ldp_route_status [::ixia::emulation_ldp_route_config                       \
        -mode                              modify                              \
        -handle                            $ldp_router                         \
        -lsp_handle                        [lindex $lsp_vc_ip_range_handles 0] \
        -fec_vc_ip_range_addr_start        22.22.22.2                          \
        ]
if {[keylget ldp_route_status status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget ldp_route_status log]"
    return
