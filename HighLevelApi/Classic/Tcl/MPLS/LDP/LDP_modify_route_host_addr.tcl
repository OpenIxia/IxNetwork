...
#    5-4-2007 removed the egress_label_mode option of the first call to 
#             ixia::emulation_ldp_config - Matei-Eugen Vasile
#
################################################################################
...
#                                                                              #
# Description:                                                                 #
#    This sample creates two LDP peers and configures host_addr fec type       #
#    routes on the first peer. Then it modifies the host_addr fec type routes. #
#                                                                              #
# Module:                                                                      #
...
#################################################
#  Modify host_addr fec type routes             #
#################################################
set ldp_routers_status [::ixia::emulation_ldp_route_config \
        -mode                   modify              \
        -handle                 $router_handle      \
