...
#                                                                              #
# Description:                                                                 #
#    This sample creates two LDP peers and configures vc fec type routes for   #
#    the first peer. Then modifies the vc fec type routes.                     #
#                                                                              #
# Module:                                                                      #
...
#################################################
#  Modify vc fec type routes                    #
#################################################
set ldp_routers_status [::ixia::emulation_ldp_route_config \
        -mode                   modify              \
        -handle                 $router_handle      \
        -lsp_handle             $lsp_handle         \
        -fec_vc_type            atm_aal5_vcc        \
        -fec_vc_intf_mtu_enable 1                   \
        -fec_vc_intf_mtu        1024                \
        -fec_vc_intf_desc       ixia_test           \
        ]
