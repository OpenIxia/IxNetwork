...
#    5-4-2007 set the mac_address_init option of the second call to 
#             ixia::emulation_ldp_config to 0000.0000.0001 - Matei-Eugen Vasile
#
################################################################################
...
#                                                                              #
# Description:                                                                 #
#    This sample creates two LDP peers and then modifies the first one.        #
#                                                                              #
# Module:                                                                      #
...
set ldp_routers_status [::ixia::emulation_ldp_config  \
        ...
        -peer_discovery             link            \
        -intf_ip_addr               22.2.2.1        \
        -intf_prefix_length         16              \
        -lsr_id                     13.1.3.1        \
        -label_space                70              \
        -gateway_ip_addr            22.2.2.2        \
