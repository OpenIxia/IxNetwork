...
#    Bidirectional MPLS traffic is configured. Traffic statistics are returned.#
#                                                                              #
# Module:                                                                      #
...
################################################################################
puts "MPLS traffic configure"

set traffic_status [::ixia::traffic_config         \
        -mode                        create        \
        -traffic_generator           ixnetwork     \
        -bidirectional               0             \
        -emulation_dst_handle        $rsvp_egress_handle_1       \
        -emulation_src_handle        $rsvp_ingress_handle_0       \
...
set traffic_status [::ixia::traffic_config         \
        ...
        -traffic_generator           ixnetwork     \
        -bidirectional               0             \
        -emulation_dst_handle        $rsvp_egress_handle_0       \
        -emulation_src_handle        $rsvp_ingress_handle_1       \
        -circuit_endpoint_type       ipv4 \
        -circuit_type                mpls           \
    ]
if {[keylget traffic_status status] != $::SUCCESS} {
