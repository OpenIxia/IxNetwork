...
#
#    Revision Log:
#    04-01-2005  T.Kong   - updated for HLTAPI V4.0 spec
#    02-21-2008  L.Raicea - updated MAC address to contain only lower case 
#                           letters, because parse_dashed_args doesn't support 
#                           upper case for MAC type
#
# Description:
#
################################################################################
...
#    neighbors are started, stopped and restarted.                             #
#                                                                              #
# Module:                                                                      #
...
set rsvp_config_status [::ixia::emulation_rsvp_config   \
        ...
        -vlan_id_mode         fixed                     \
        -vlan_id_step         2                         \
        -mac_address_init     0000.a000.f001            \
...
set ingress_tunnel_handle [keylget rsvp_tunnel_config_status tunnel_handle]
set ingress_tunnel_1 [lindex $ingress_tunnel_handle 0]
...
set egress_tunnel_handle [keylget rsvp_tunnel_config_status tunnel_handle]
set egress_tunnel_1 [lindex $egress_tunnel_handle 0]
