...
#
#    Revision Log:
#    04-4-2005  T.Kong - created for HLTAPI V4.0 spec
#
# Description:
#
################################################################################
...
#                                                                              #
# Description:                                                                 #
#    This sample creates a RSVP neighbor and configures it as Ingress LSR.     #
#    Then modifies the configuration and disables the neighbor.                #
#                                                                              #
# Module:                                                                      #
...
set tunnel_handle_list [keylget rsvp_tunnel_config_status tunnel_handle]

foreach tunnel_handle $tunnel_handle_list {

    set rsvp_tunnel_config_status [::ixia::emulation_rsvp_tunnel_config   \
            -mode                               modify          \
            -count                              2               \
            -tunnel_pool_handle                 $tunnel_handle  \
            -ingress_ip_addr                    123.0.0.1       \
            -ingress_ip_step                    0.1.0.0         \
            -ingress_bandwidth                  5000            \
            -lsp_id_start                       500             \
            -tunnel_id_start                    50              \
            -tunnel_id_count                    5               \
            -tunnel_id_step                     20              \
