...
#
#    Revision Log:
#    07-15-2009  B.Danciu - created sample
#
# Description:
#
################################################################################
...
set intf_handle1 [keylget interface_status interface_handle]


set interface_status [::ixia::interface_config \
        -port_handle        [list $ingress_port  $ingress_port  $ingress_port]     \
        -intf_mode          ethernet         \
        -src_mac_addr       [list 0000.aaaa.0001 0000.aaaa.0002 0000.aaaa.0003]    \
        -vlan               1                \
        -vlan_id            300              \
        -vlan_id_step       2                \
        -vlan_id_count      1                \
        -vlan_user_priority 0                \
        -intf_ip_addr       [list 4.4.4.100      4.5.4.100      4.6.4.100 ]        \
        -gateway            3.3.3.100        \
        -netmask            255.255.255.0    \
        -autonegotiation    1                \
        -duplex             auto             \
...
set unconnected_handles1 [keylget interface_status interface_handle]
...
set intf_handle2 [keylget interface_status interface_handle]

set interface_status [::ixia::interface_config \
        -port_handle        [list $egress_port   $egress_port   $egress_port]     \
        -intf_mode          ethernet         \
        -src_mac_addr       [list 0000.bbbb.0001 0000.bbbb.0002 0000.bbbb.0003]   \
        -vlan               1                \
        -vlan_id            300              \
        -vlan_id_step       2                \
        -vlan_id_count      1                \
        -vlan_user_priority 0                \
        -intf_ip_addr       [list 2.2.2.100      2.3.2.100      2.4.2.100]      \
        -gateway            3.3.3.1          \
        -netmask            255.255.255.0    \
        -autonegotiation    1                \
        -duplex             auto             \
...
set unconnected_handles2 [keylget interface_status interface_handle]
