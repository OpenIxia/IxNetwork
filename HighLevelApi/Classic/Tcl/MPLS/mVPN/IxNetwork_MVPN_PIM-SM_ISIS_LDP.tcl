...
#  ip address 21.111.111.111 255.255.255.255
#  ip pim sparse-mode
# 
...
#  neighbor 22.2.2.2 update-source Loopback20
#  neighbor 22.2.2.3 remote-as 1
#  neighbor 22.2.2.3 update-source Loopback20
# 
...
set pe_dut_ip_addr_start 21.111.111.111
...
# Waiting for all packets which pass througth DUT
after 10000
