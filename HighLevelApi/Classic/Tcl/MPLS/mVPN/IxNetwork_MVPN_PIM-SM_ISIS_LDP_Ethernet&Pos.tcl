...
# ip multicast-routing vrf mvpn910
# 
...
# exit
# 
# ip pim rp-address 21.1.1.1
# ip pim vrf mvpn910 rp-address 20.31.31.1
# 
# interface POS 4/1
# description Provider
# no shutdown
# ip address 20.30.30.1 255.255.255.0
# ip router isis mvpn910
# ip pim sparse-mode
...
# no shutdown
# 
# interface gigabitEthernet7/36.1
# description Customer
# encapsulation dot1Q 910
# ip vrf forwarding mvpn910
# ip address 20.31.31.1 255.255.255.0
# ip pim sparse-mode
# exit
# 
# router bgp 1
# neighbor 23.34.35.1 remote-as 1
# neighbor 23.34.35.1 update-source Loopback20
# address-family vpnv4
# neighbor 33.34.35.1 activate
# neighbor 33.34.35.1 send-community extended
# exit-address-family
# address-family ipv4 vrf mvpn910
# no auto-summary
# no synchronization
...
#     
# Module:                                                                      
#    The sample was tested on a MSM2.5 POS module (Provider Side) and a        
...
set p_ip_addr_start 20.30.30.2
set p_ip_addr_step  0.0.0.0
set p_gw_addr       20.30.30.1
set p_ip_prefix     24
set p_rp_addr_start 20.10.10.10
set p_rp_addr_step  0.0.0.0

# Set PE Routers parameters
set pe_count             1
set pe_ip_addr_start     23.34.35.1
set pe_ip_addr_step      0.0.0.1
set pe_dut_ip_addr_start 21.1.1.1
...
set mvpn_rp_addr_start        20.31.31.1
