...
# ip vrf 910
#     rd 1:910
#     route-target both 1:910
#     mdt default 239.1.1.1
# 
# ip vrf 911
#     rd 1:911
#     route-target both 1:911
...
#     ip address  20.0.110.1 255.255.255.255
#     ip pim sparse-mode
#     ip router isis
# 
...
#     ip unnumbered Loopback29
#     no ip directed-broadcast
#     tunnel destination 22.2.2.2
...
#     is-type level-1
#     metric-style wide
#     mpls traffic-eng router-id Loopback29
...
#     neighbor 22.2.2.2 remote-as 1
#     neighbor 22.2.2.2 update-source Loopback29
#     neighbor 22.2.2.3 remote-as 1
#     neighbor 22.2.2.3 update-source Loopback29
# 
#     address-family vpnv4
#     neighbor 22.2.2.2 activate
#     neighbor 22.2.2.2 send-community extended
#     neighbor 22.2.2.3 activate
#     neighbor 22.2.2.3 send-community extended
#     exit-address-family
# 
...
set pe_count             2
set pe_ip_addr_start     22.2.2.2
set pe_ip_addr_step      0.0.0.1
set pe_dut_ip_addr_start 20.0.110.1
...
set pe_isis_grid_start            23.1.2.3
...
set route_config_status [::ixia::emulation_isis_topology_route_config \
        ...
        -grid_link_type         ptop                    \
        -grid_ip_start          $pe_isis_grid_start     \
        -grid_te                1                       \
        -link_enable            1                       ]
