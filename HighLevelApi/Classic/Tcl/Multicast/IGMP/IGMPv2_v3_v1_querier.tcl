...
#                                                                              #
# Description:                                                                 #
#    This template creates and starts an IGMPv2, an IGMPv3 and                 #
#    IGMPv1 queriers. Also it creates an IGMPv3, IGMPv2 and IMGPv3             #
#    hosts and  multicast groups pools that will be assigned to the hosts.     #
#                                                                              #
# Module:                                                                      #
...
#Configure IGMPv2 groups
set session_handle       90.34.1.1
set mgroup_params  [list 226.0.2.1/0.0.0.1/5                       226.0.2.6/0.0.0.2/4]
set msource_params [list 90.34.1.2/0.0.0.2/2,100.0.2.2/0.0.0.1/3   200.0.2.2/0.0.0.1/5,140.0.2.2/0.0.0.1/5,150.0.2.2/0.0.0.1/5]
...
puts "Configure IGMPv3 hosts"

#Confgiure IGMPv3 hosts
...
puts "Create IGMPv3 group"

#Configure IGMPv3 pool group
...
# Configure IGMPv1 group pool 

set session_handle     40.0.1.2
set mgroup_params  [list 226.0.3.1/0.0.0.1/5                       226.0.3.6/0.0.0.2/4]
set msource_params [list 100.0.3.2/0.0.0.2/2,110.0.3.2/0.0.0.1/3   120.0.3.2/0.0.0.1/5,130.0.3.2/0.0.0.1/5,140.0.3.2/0.0.0.1/5]
...
puts "Configure IGMPv2 querier..."

#Confgiure IGMP querier
set ip_router_alert         1
set host            90.34.1.1
set query           90.34.1.2
set vlan_id                 10
...
puts "Configure IGMPv3 querier..."

#Configure IGMPv3 querier
set ip_router_alert         1
set host                    100.0.1.2
set query                   100.0.1.1
set vlan_id                 10
...
puts "Configure IGMPv1 querier..."

#Confgiure IGMPv1 querier
...
set igmp_status [::ixia::emulation_igmp_querier_config          \
        ...
        -vlan_user_priority                $vlan_user_priority  \
        -ip_router_alert                   1                    \
        -mac_address_init                  00ac.c1cc.ddd0       \
        -mac_address_step                  0000.0000.0001       \
        -override_existence_check          1                    \
        -override_tracking                 1                    \
        -vci                               3400                 \
...
#Add host and querier handle to a single list to start all hosts and queriers with one command 
