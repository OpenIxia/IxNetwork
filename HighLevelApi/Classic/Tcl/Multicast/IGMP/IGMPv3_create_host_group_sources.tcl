...
#                                                                              #
# Description:                                                                 #
#    This sample creates an IGMP v3 host, a pool of five multicast groups      #
#    and a pool of five multicast sources. Each source in the source pool      #
#    is added to each group in the group pool and all the groups in the        #
#    group pool are added to the host. The filter mode for the sources is      #
#    exclude.                                                                  #
#                                                                              #
# Module:                                                                      #
...
set msource [keylget mcast handle]
...
set group_status [::ixia::emulation_igmp_group_config   \
        ...
        -group_pool_handle              $mgroup         \
        -source_pool_handle             $msource        \
        ]
