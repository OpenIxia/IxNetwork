...
#                                                                              #
# Description:                                                                 #
#    This sample creates five IGMP v3 hosts (two on a port, three on another   #
#    port), five group pools and five source pools. Then combinations of       #
#    group pools and source pools are added to the hosts. In the end two       #
#    hosts are deleted.                                                        #
#                                                                              #
# Module:                                                                      #
...
# Delete sessions 1 and session4
