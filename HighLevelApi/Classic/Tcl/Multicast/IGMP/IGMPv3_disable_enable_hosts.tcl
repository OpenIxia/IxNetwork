...
#                                                                              #
# Description:                                                                 #
#    This sample creates IGMP v3 host on two ports. It adds group pools and    #
#    source pools to the hosts. It disables and enables some hosts.            #
#                                                                              #
# Module:                                                                      #
...
# Disable sessions 1, 3 and 4
set igmpConf [::ixia::emulation_igmp_config                   \
        -handle                                             \
                [list $session1 $session3 $session4]        \
        -mode                           disable             \
        ]
