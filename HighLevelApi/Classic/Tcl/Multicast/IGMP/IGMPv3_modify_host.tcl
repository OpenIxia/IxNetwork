...
#                                                                              #
# Description:                                                                 #
#    This sample creates an IGMP v3 host. It creates two group pools and two   #
#    two source pools. It adds group pools and source pools to the host. The   #
#    filter mode for the multicast sources in source pools is exclude. Then    #
#    it changes the filter mode to include.
#                                                                              #
# Module:                                                                      #
...
set session_modify [::ixia::emulation_igmp_config       \
        -mode                           modify          \
        -handle                         $session        \
        -filter_mode                    include         \
        -ip_router_alert                0               \
        ]
if {[keylget session_modify status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget session_modify log]"
}
