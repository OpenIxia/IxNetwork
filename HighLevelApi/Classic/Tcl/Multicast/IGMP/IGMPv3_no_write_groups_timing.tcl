...
set session_handle_0 [keylget igmp_status handle]
...
set gr_count  500       ;# number of IGMP groups
...
if {[keylget group_status_0 status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget group_status_0 log]"
}
set stop_time [clock clicks -milliseconds]
puts "Timing with no_write for $gr_count groups and $ct sources ==> [expr $stop_time - $start_time] milliseconds"
