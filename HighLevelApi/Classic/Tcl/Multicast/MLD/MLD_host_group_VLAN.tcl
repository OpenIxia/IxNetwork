...
# $Author: Karim $
#
# $Workfile: sample_ixia_hltapi_MLD_host_group_vlan.tcl $
#
...
#    then adds the groups in the pool to each MLD hosts. The MLD hosts have    #
#    VLAN interfaces.                                                          #
#                                                                              #
# Module:                                                                      #
...
#####################################################################
#  Configure 1 MLD groups on each MLD groups on interface 1/10/1    #
#  MLD Version 2                                                    #
#####################################################################
