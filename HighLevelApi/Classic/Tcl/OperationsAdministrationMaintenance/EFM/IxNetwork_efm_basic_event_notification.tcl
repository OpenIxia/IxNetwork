...
#    One Information OAMPDU is added on each port.                             #
#    One Event Notification OAM with 4 TLV (Error Frame, Error Frame Period,   #
#    Error Frame Summary and Error Symbol Period) is added on each port.       #
...
if {[keylget stat_status1 statistics.oampdu_count.event_notification_rx] <= 0} {
    puts "FAIL - $test_name - EOAM Event Notification PDUs Received count is 0."
    return
}
...
if {[keylget stat_status2 statistics.oampdu_count.event_notification_rx] <= 0} {
    puts "FAIL - $test_name - EOAM Event Notification PDUs Received count is 0."
    return
}
