...
#    OUI and Vendor Specific Information are configured on both ports.         #
...
set efm_status [::ixia::emulation_efm_config    \
        ...
        -link_events                            \
        -variable_retrieval                     \
        -local_information_oui_value      112233\
        -local_information_vsi_value    11223344\
        -oui_value                        112233\
        -vsi_value                      11223344\
        -remote_information_oui_value     aabbcc\
        -remote_information_vsi_value   aabbccdd\
    ]
...
set efm_status [::ixia::emulation_efm_config    \
        ...
        -link_events                            \
        -variable_retrieval                     \
        -local_information_oui_value      aabbcc\
        -local_information_vsi_value    aabbccdd\
        -oui_value                        aabbcc\
        -vsi_value                      aabbccdd\
        -remote_information_oui_value     112233\
        -remote_information_vsi_value   11223344\
        ]
if {[keylget efm_status status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget efm_status log]"
    return
