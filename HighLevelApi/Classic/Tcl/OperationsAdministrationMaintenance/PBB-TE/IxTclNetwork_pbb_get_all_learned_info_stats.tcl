...
#    starts the protocol and retrieves learned information.                    #
...
foreach port_h $port_handle { 
    set bridge_handles [set pbb_handles_$port] 
    set bridge 1
    puts "\n### periodic_oam_dm stats for bridges on port $port_h"
    foreach handle $bridge_handles {
        set pbb_info_status_1 [::ixia::emulation_pbb_info                      \
                -mode                               set_filters                \
                -handle                             $handle                    \
                -user_bvlan                         all_vlan_id                \
                -user_delay_type                    dvm                        \
                -user_dst_type                      mep_mac_all                \
                -user_mdlevel                       all_md                     \
                -user_src_type                      mep_mac_all                \
                -user_transaction_id                1                          \
                -user_ttl_interval                  64                         \
                -user_usability_option              manual                     \
                ]
        ...
        puts "#Statistics for bridge $handle:"
