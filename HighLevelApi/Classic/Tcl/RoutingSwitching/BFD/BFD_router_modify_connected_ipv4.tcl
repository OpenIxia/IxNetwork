...
set bfd_router2 [lindex [keylget bfd_router_status router_handles] 1]
set bfd_router_intf2 [lindex [keylget bfd_router_status router_interface_handles.$bfd_router2] 1]

set bfd_router_modify_status [::ixia::emulation_bfd_config  \
        -mode                       modify                  \
        -handle                     $bfd_router_intf2       \
        -intf_ip_addr               27.1.1.100              \
        -router_id                  27.1.1.100              \
