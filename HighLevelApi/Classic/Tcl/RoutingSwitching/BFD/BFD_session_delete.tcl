...
foreach router $router_handles {
    set bfd_session_status [::ixia::emulation_bfd_session_config \
            ...
            -local_ip_addr_step     10.0.0.0                \
            -remote_ip_addr         10$i.0.0.1              \
            -remote_ip_addr_step    10.0.0.0                \
            -session_type           single_hop              \
            ]
    if {[keylget bfd_session_status status] != $::SUCCESS} {
        return "FAIL - [keylget bfd_session_status log]"
    }
    append session_handles " [keylget bfd_session_status session_handles]"
    incr i
}
