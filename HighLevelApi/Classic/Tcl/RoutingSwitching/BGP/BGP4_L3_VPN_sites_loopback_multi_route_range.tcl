...
#                                                                              #
# Description:                                                                 #
#    This sample configures two internal BGP neighbors on loopback interfaces  #
#    and on each neighbor it adds two VRFs.                                    #
#                                                                              #
# Module:                                                                      #
...
set bgp_route_range_status [::ixia::emulation_bgp_route_config \
        ...
        -import_target        200.1.1.1      \
        -import_target_assign 150            \
        -ipv4_unicast_nlri                   \
        -ipv4_multicast_nlri                 \
        -ipv4_mpls_nlri                      \
        -ipv4_mpls_vpn_nlri                  \
