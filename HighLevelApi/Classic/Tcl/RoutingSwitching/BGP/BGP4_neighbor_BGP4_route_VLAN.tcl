...
#                                                                              #
# Description:                                                                 #
#    This sample configures two internal BGP neighbors on VLAN interfaces and  #
#    adds two IPv4 route ranges and two IPv6 route ranges on each neighbor.    #
#                                                                              #
# Module:                                                                      #
...
if {[keylget interface_status status] != $::SUCCESS} {
    return "FAIL - sample_ixia_hltapi_BGP4_neighbor_BGP4_route_vlan.tcl -\
...
return "SUCCESS - sample_ixia_hltapi_BGP4_neighbor_BGP4_route_vlan.tcl -\
