...
#                                                                              #
# Description:                                                                 #
#    This sample configures two external neighbors and on each neighbor two    #
#    route ranges. Then it deletes the second route range from the second      #
#    neighbor.                                                                 #
#                                                                              #
# Module:                                                                      #
...
set neighbor2_handle [lindex $bgp_ipv4_route_handle_list 1]

set route_handle_list [keylget neighbor2_handle bgp_routes]

# Remove the 2nd BGP route on the 2nd BGP neighbor
set bgp_ipv4_route_handle [::ixia::emulation_bgp_route_config \
        -handle       [lindex $bgp_router_handle_list 1] \
        -route_handle [lindex $route_handle_list 1 ]     \
        -mode         remove                             ]
