...
#                                                                              #
# Description:                                                                 #
#    This sample tries to create 3 EIGRP routers with directly connected IPv6  #
#    interfaces. The call will fail because EIGRP needs an IPv4 item.          #
#                                                                              #
# Module:                                                                      #
...
set eigrp_router_status [::ixia::emulation_eigrp_config  \
        ...
        -count      		            3              \
        -intf_ipv6_addr                 25::2          \
        -intf_ipv6_addr_step            0:1::0         \
        -intf_ipv6_prefix_length        24             \
        -vlan                           1              \
        -vlan_id                        25             \
        -vlan_id_step                   1              \
        -router_id                      25.0.0.2       \
...
# This should fail, because EIGRP cannot be connected through an IPv6 interface
# An IPv4 address must be present
if {[keylget eigrp_router_status status] != $::FAILURE} {
