...
# $Author: T. Kong $
#
# $Workfile: ISIS_topology_delete_ext.tcl $
#
...
#                                                                              #
# Description:                                                                 #
#    This sample creates an ISIS router and adds an external route range for   #
#    it. Then it deletes the external route range.                             #
#                                                                              #
# Module:                                                                      #
...
##############################################################
#  Delete ISIS external route range                          #
##############################################################
    set route_config_status [::ixia::emulation_isis_topology_route_config \
            -mode                   delete                  \
            -handle                 $isis_router_handle     \
