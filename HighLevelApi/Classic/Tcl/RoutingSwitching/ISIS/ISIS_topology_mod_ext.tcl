...
# $Author: T. Kong $
#
# $Workfile: ISIS_topology_mod_ext.tcl $
#
...
#                                                                              #
# Description:                                                                 #
#    This sample creates an ISIS router and configures an external route range #
#    for it.                                                                   #
#                                                                              #
# Module:                                                                      #
...
##############################################################
#  For each ISIS router modify external route range          #
##############################################################
    set route_config_status [::ixia::emulation_isis_topology_route_config \
            -mode                   modify                  \
            -handle                 $isis_router_handle     \
            ...
            -type                   external                \
            -ip_version             4_6                     \
            -external_ip_start      99.0.0.1                \
            -external_ip_pfx_len    16                      \
            -external_ipv6_start    9000:0:0:1::1           \
            -external_ipv6_pfx_len  96                      \
            -external_count         10                      \
            -external_metric        10                      \
            -external_up_down_bit   1                       \
