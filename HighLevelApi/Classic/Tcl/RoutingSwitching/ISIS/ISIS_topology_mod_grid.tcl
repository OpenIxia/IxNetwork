...
#    the ISIS session router. Then modifies the topology.                      #
#                                                                              #
# Module:                                                                      #
...
###########################
    ...
    set route_config_status [::ixia::emulation_isis_topology_route_config \
            ...
            -type                   grid                    \
            -ip_version             4_6                     \
            -grid_start_system_id   112233445566            \
            -grid_system_id_step    000000000005            \
            -router_id              44.0.0.7                \
            -router_area_id         AA0001 BB0002 CC2233    \
            -grid_row               15                       \
            -grid_col               15                       \
            -grid_stub_per_router   15                      \
            -grid_router_id         55.0.0.1                \
            -grid_router_id_step    0.0.1.0                 \
            -grid_ip_start          66.0.0.1                \
            -grid_ip_pfx_len        24                      \
            -grid_ip_step           0.0.1.0                 \
            -grid_connect           5 5                     \
            -grid_interface_metric  30                      \
            -grid_link_type         broadcast               \
            -grid_router_metric     10                      \
            -grid_router_up_down_bit 1                      \
            -grid_router_origin     stub                    \
            -grid_te                1                       \
            -grid_start_te_ip       33.0.0.1                \
            -grid_te_ip_step        0.0.1.0                 \
