...
# $Author: T. Kong $
#
# $Workfile: ISIS_topology_mod_stub.tcl $
#
...
#                                                                              #
# Description:                                                                 #
#    This sample creates an ISIS router and adds a stub route range for it.    #
#    Then it modifies the stub route range.                                    #
#                                                                              #
# Module:                                                                      #
...
##############################################################
#  For each ISIS router configure stub route range           #
##############################################################
...
set route_config_status [::ixia::emulation_isis_topology_route_config \
        ...
        -stub_ip_pfx_len        20                      \
        -stub_ipv6_start        5000:0:0:1::1           \
        -stub_ipv6_pfx_len      86                      \
        -stub_count             5                       \
        -stub_metric            22                      \
        -stub_up_down_bit       1                       \
        ]
...
##############################################################
#  For each ISIS router modify stub route range              #
##############################################################
    set route_config_status [::ixia::emulation_isis_topology_route_config \
            -mode                   modify                  \
            -handle                 $isis_router_handle     \
            ...
            -type                   stub                    \
            -ip_version             4_6                     \
            -stub_ip_start          99.0.0.1                \
            -stub_ip_pfx_len        20                      \
            -stub_ipv6_start        9000:0:0:1::1           \
            -stub_ipv6_pfx_len      86                      \
            -stub_count             10                      \
            -stub_metric            10                      \
            -stub_up_down_bit       1                       \
