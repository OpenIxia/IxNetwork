...
set local_ip_address        [script_expand_ipv6_address 2001::2]
set local_ip_address_step   [script_expand_ipv6_address 0:1::]

set route_range_ip_address  [script_expand_ipv6_address 2000:1000::1]
set route_range_step        [script_expand_ipv6_address 0:1000::]
...
for {set i 0} {$i < $port_count} {incr i} {
    set isis_router_status [::ixia::emulation_isis_config                     \
            ...
            -intf_ipv6_addr             $local_ip_address_temp              \
    ...
    set local_ip_address_temp [script_increment_ipv6_address                \
...
for {set i 0} {$i < $port_count} {incr i} {
    ...
    set route_config_status [::ixia::emulation_isis_topology_route_config     \
            ...
            -type                   stub                                    \
            -ip_version             6                                       \
            -stub_ipv6_start        $route_range_ip_address_temp            \
            -stub_ipv6_step         [script_expand_ipv6_address 0:0:8::]    \
            -stub_ipv6_pfx_len      48                                      \
            -stub_count             5                                       \
            -stub_metric            22                                      \
            ]
    ...
    set route_range_ip_address_temp [script_increment_ipv6_address          \
