...
#                                                                              #
# Description:                                                                 #
#    This sample creates 20 OSPFv2 routers.                                    #
#                                                                              #
# Module:                                                                      #
...
set ospf_neighbor_status [::ixia::emulation_ospf_config \
        ...
        -intf_ip_addr               50.1.1.1         \
        -intf_ip_addr_step          0.0.1.0          \
        -neighbor_intf_ip_addr      50.1.1.2         \
        -neighbor_intf_ip_addr_step 0.0.1.0          \
        -vlan                       1                \
        -vlan_id                    1000             \
        -vlan_id_mode               fixed            \
...
set ospf_neighbor_status [::ixia::emulation_ospf_config \
        ...
        -mode                       create           \
        -count                      5                \
        -mac_address_init           3000.0000.0001   \
        -intf_ip_addr               40.1.1.1         \
        -intf_ip_addr_step          0.0.1.0          \
        -neighbor_intf_ip_addr      40.1.1.2         \
        -neighbor_intf_ip_addr_step 0.0.1.0          \
        -area_id                    0.0.0.100        \
        -area_type                  external-capable \
