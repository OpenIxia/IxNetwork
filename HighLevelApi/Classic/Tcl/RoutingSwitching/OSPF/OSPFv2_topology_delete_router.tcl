...
# $Author: T. Kong $
#
# $Workfile: OSPFv2_topology_delete_route.tcl $
#
...
#                                                                              #
# Description:                                                                 #
#    This sample creates two OSPFv2 routers on two different ports. It         #
#    configures a single router behind a session router. Then it deletes       #
#    the router topology configuration.                                        #
#                                                                              #
# Module:                                                                      #
