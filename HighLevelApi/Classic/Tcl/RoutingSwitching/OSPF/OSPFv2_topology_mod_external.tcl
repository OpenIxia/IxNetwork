...
# $Author: T. Kong $
#
# $Workfile: OSPFv2_topology_mod_external.tcl $
#
...
######################################################
#                                                    #
#  Configure a external route behind a session router #
#                                                    #
######################################################
set route_config_status [::ixia::emulation_ospf_topology_route_config\
        ...
        -external_prefix_start      44.0.0.1    \
...
######################################################
#                                                    #
#  Modify a External Router Config                   #
#                                                    #
######################################################
set route_config_status [::ixia::emulation_ospf_topology_route_config\
        -mode           modify                  \
        ...
        -type           ext_routes              \
        -external_number_of_prefix  10          \
        -external_prefix_start      88.0.0.1    \
        -external_prefix_length     32          \
        -external_prefix_metric     8           \
