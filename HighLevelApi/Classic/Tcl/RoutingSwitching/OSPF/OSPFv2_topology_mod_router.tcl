...
# $Author: T. Kong $
#
# $Workfile: OSPFv2_topology_mod_route.tcl $
#
...
#    first router it configures a single router behind the session router.     #
#    Then it modifies the router topology configuration.                       #
#                                                                              #
# Module:                                                                      #
...
########################################################
#                                                      #
#  Modify router configuration behind a session router #
#                                                      #
########################################################
set route_config_status [::ixia::emulation_ospf_topology_route_config\
        -mode           modify                  \
