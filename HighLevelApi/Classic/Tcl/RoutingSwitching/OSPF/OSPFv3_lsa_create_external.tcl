...
# $Author: T. Kong $
#
# $Workfile: OSPFv3_lsa_create_external.tcl $
#
...
#                                                                              #
#       ::ixia::emulation_ospf_lsa_config to configure a As External LSA       #
#                                                                              #
# Module:                                                                      #
...
foreach ospf_handle $ospf_handle_list {
    set ospf_lsa_status [::ixia::emulation_ospf_lsa_config  \
            ...
            -external_prefix_start        fec0:0:0:5::100 \
            -external_prefix_length       10              \
            -external_prefix_metric       4               \
            -external_prefix_step         0.0.0.1         \
            -external_prefix_type         1               \
            -external_prefix_forward_addr fec0:0:0:5::1   \
    ...
    set ospf_lsa_status [::ixia::emulation_ospf_lsa_config  \
            ...
            -external_prefix_start        5000:0:0:5::100 \
            -external_prefix_length       24              ]
