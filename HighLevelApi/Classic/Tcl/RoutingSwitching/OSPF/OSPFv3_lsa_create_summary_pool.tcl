...
# $Author: T. Kong $
#
# $Workfile: OSPFv3_lsa_create_summary_pool.tcl $
#
...
#                                                                              #
#       ::ixia::emulation_ospf_lsa_config to configure a Summary Pool LSA      #
#                                                                              #
# Module:                                                                      #
...
foreach ospf_handle $ospf_handle_list {
   set ospf_lsa_status [::ixia::emulation_ospf_lsa_config \
           ...
           -link_state_id_step       0.0.2.0            \
           -prefix_options           8                  \
           -summary_number_of_prefix 32                 \
           -summary_prefix_start     fec0::100          \
           -summary_prefix_length    10                 \
           -summary_prefix_step      0.0.0.1            \
    ...
    set ospf_lsa_status [::ixia::emulation_ospf_lsa_config \
           ...
           -adv_router_id            11.0.0.3            \
           -link_state_id            22.0.0.3            \
           -summary_number_of_prefix 24 ]
