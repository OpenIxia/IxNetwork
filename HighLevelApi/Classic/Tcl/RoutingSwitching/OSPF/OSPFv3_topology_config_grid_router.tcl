...
# $Author: T. Kong $
#
# $Workfile: OSPFv3_topology_config_grid_router.tcl $
#
...
#    the first router it configures a grid topology and a router behind the    #
#    session router.                                                           #
#                                                                              #
# Module:                                                                      #
...
########################################################
#                                                      #
#  Configure a grid of routers behind a session router #
#                                                      #
########################################################
set route_config_status [::ixia::emulation_ospf_topology_route_config\
        ...
        -grid_prefix_start 3000:0:0:1::1        \
        -grid_prefix_length 32                  \
...
set route_config_status [::ixia::emulation_ospf_topology_route_config\
        ...
        -interface_ip_address   2000:0:0:1::1   \
        ]
