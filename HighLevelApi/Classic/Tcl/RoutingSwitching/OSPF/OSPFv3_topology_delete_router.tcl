...
# $Author: T. Kong $
#
# $Workfile: OSPFv3_topology_delete_router.tcl $
#
...
#                                                                              #
# Description:                                                                 #
#    This sample creates an OSPFv3 router and configures a router behind the   #
#    session router. Then it deletes the router.                               #
#                                                                              #
# Module:                                                                      #
...
########################################################
#                                                      #
#  Delete a router topology configuration              #
#                                                      #
########################################################
set route_config_status [::ixia::emulation_ospf_topology_route_config\
        -mode           delete                  \
