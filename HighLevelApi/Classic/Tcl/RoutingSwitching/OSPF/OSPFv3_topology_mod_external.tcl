...
# $Author: T. Kong $
#
# $Workfile: OSPFv3_topology_mod_external.tcl $
#
...
#                                                                              #
# Description:                                                                 #
#    This sample creates two OSPFv3 routers on two different ports. On the     #
#    first router it configures a pool of external routes. Then it modifies    #
#    the external routes.                                                      #
#                                                                              #
# Module:                                                                      #
...
##########################################################
#                                                        #
#  Configure a external topology behind a session router #
#                                                        #
##########################################################
set route_config_status [::ixia::emulation_ospf_topology_route_config\
        ...
        -external_prefix_start      2500:0:0:2::1 \
        -external_prefix_length     32          \
        -external_prefix_metric     10          \
        -external_prefix_type       1           \
        -external_prefix_step       3           \
        ]
...
set route_config_status [::ixia::emulation_ospf_topology_route_config\
        ...
        -type           ext_routes              \
        -external_number_of_prefix  10          \
        -external_prefix_start      5000:0:0:2::1 \
        -external_prefix_length     5          \
        -external_prefix_metric     5          \
        -external_prefix_type       1           \
        -external_prefix_step       5           \
        ]
