...
# $Author: T. Kong $
#
# $Workfile: OSPFv3_topology_mod_network.tcl $
#
...
#    first router it configures a subnet behind the session router. Then it    #
#    modifies the subnet configuration.                                        #
#                                                                              #
# Module:                                                                      #
...
######################################################
#                                                    #
#  Configure a network behind a session router       #
#                                                    #
######################################################
set route_config_status [::ixia::emulation_ospf_topology_route_config\
        ...
        -type           network                 \
        -net_ip         3000:0:0:1::1           \
        -net_prefix_length  20                  \
        -net_prefix_options 02                  \
        ]
...
set route_config_status [::ixia::emulation_ospf_topology_route_config\
        ...
        -type           network                 \
        -net_ip         5000:0:0:1::1           \
        -net_prefix_length  32                  \
        -net_prefix_options 01                  \
        ]
