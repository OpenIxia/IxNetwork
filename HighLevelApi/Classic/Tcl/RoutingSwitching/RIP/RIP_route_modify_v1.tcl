...
#                                                                              #
# Description:                                                                 #
#    This sample creates a RIPv1 router and adds two route ranges to it. Then  #
#    it modifies the route ranges.                                             #
#                                                                              #
# Module:                                                                      #
...
set route_range1 [keylget rip_status route_handle]
...
set route_range2 [keylget rip_status route_handle]
set rip_route_ranges [list $route_range1 $route_range2]
