...
#                                                                              #
# Description:                                                                 #
#    This sample creates three RIPv2 routers, then another three.               #
#                                                                              #
# Module:                                                                      #
...
###################################################
# Create the first three sessions
set rip_status [::ixia::emulation_rip_config          \
        -port_handle                 $port_handle   \
        -mode                        create         \
        -reset                                      \
        -intf_ip_addr                10.42.1.10     \
...
# Create the next three sessions
set rip_status [::ixia::emulation_rip_config          \
        -port_handle                 $port_handle   \
        -mode                        create         \
        -intf_ip_addr                10.42.1.20     \
        -neighbor_intf_ip_addr       10.42.1.1      \
        -intf_prefix_length          24             \
        -update_interval             50             \
        -update_interval_offset      5              \
        ...
        -vlan_id                     12             \
        -count                       3              \
        -mac_address_init            0000.0000.0020 ]
if {[keylget rip_status status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget rip_status log]"
}
