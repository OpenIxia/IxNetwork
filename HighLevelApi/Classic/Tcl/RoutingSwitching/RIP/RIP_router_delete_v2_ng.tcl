...
#                                                                              #
# Description:                                                                 #
#    This sample creates three RIPv2 routers and three RIPng routers. Then it  #
...
set rip_handles [concat $rip_handles [keylget rip_status handle]]

# Delete session1 and session4
set rip_status [::ixia::emulation_rip_config                              \
        -mode   delete                                                  \
        -handle [list [lindex $rip_handles 0] [lindex $rip_handles 3]]  \
        ]
if {[keylget rip_status status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget rip_status log]"
}
