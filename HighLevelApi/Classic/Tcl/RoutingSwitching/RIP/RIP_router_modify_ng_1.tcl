...
#                                                                              #
# Description:                                                                 #
#    This sample creates three RIPng routers and modifies them.                #
#                                                                              #
# Module:                                                                      #
...
set rip_status [::ixia::emulation_rip_config         \
        ...
        -reset                                     \
        -session_type                ripng         \
        -intf_ip_addr                10:10:10:10:5:5:5:5 \
...
set ripng_handles [keylget rip_status handle]
set rip_status [::ixia::emulation_rip_config               \
        -mode                        modify              \
        -handle                      $ripng_handles      \
        -time_period                 200                 \
        -num_routes_per_period       20                  \
        -update_interval             30                  \
        -update_interval_offset      3                   \
