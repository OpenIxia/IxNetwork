...
#                                                                              #
# Description:                                                                 #
#    This sample creates three RIPv2 routers and modifies them.                #
#                                                                              #
# Module:                                                                      #
...
array set send_type [list \
        1 multicast    \
        2 multicast    \
        3 broadcast_v2 ]
        
array set authentication_mode [list \
        1 null         \
        2 text         \
        3 text         ]

array set password [list \
        1 aaaaa        \
        2 bbbbb        \
        3 ccccc        ]
set i 1
foreach handle $rip_handles {
    set rip_status [::ixia::emulation_rip_config         \
            ...
            -authentication_mode         $authentication_mode($i)     \
            -password                    $password($i)                \
            -send_type                   $send_type($i)               \
