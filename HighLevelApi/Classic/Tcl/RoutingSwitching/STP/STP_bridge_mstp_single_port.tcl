...
#    stacked VLAN.                                                             #
#    On the first STP bridge, five MSTI objects are being configured.          #
#                                                                              #
# Module:                                                                      #
...
set stp_status [::ixia::emulation_stp_bridge_config    \
        ...
        -auto_pick_port                 0              \
        -bridge_mac                     2234.5678.9abc \
        -bridge_mac_step                0000.0000.0005 \
        -bridge_mode                    mstp           \
        -bridge_priority                8192           \
        -cist_external_root_cost        5              \
        -cist_external_root_mac         aaaa.bbbb.cccc \
        -cist_external_root_priority    4096           \
        -cist_reg_root_cost             10             \
        -cist_reg_root_mac              abcd.abcd.abcd \
        -cist_reg_root_priority         16384          \
        -cist_remaining_hop             10             \
        -count                          5              \
        -enable_jitter                  1              \
        -forward_delay                  1000           \
        -hello_interval                 1500           \
        ...
        -mac_address_init               3111.2222.1111 \
...
################################################################################
# Create MSTI objects on first STP bridge
################################################################################
set stp_status [::ixia::emulation_stp_msti_config    \
        ...
        -msti_id_step                 1              \
        -msti_hops                    13             \
        -msti_internal_root_path_cost 17             \
        -msti_mac                     1234.1234.1234 \
        -msti_mac_step                0000.0002.0001 \
        -msti_name                    "msti-%"       \
        -msti_port_priority           176            \
        -msti_priority                61440          \
        -msti_vlan_start              7              \
        -msti_vlan_start_step         2              \
        -msti_vlan_stop               13             \
        -msti_wildcard_percent_enable 1              \
        -msti_wildcard_percent_start  10             \
        -msti_wildcard_percent_step   2              \
        ]
if {[keylget stp_status status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget stp_status log]"
    return
...
# Retrieve first handle from MSTI objects
set msti_handle [lindex [keylget stp_status handle] 0]
