...
#   bridge created for each Ixia port. The protocol is started.                #
#   Statistics and learned infomation are being retrieved.                     #
#                                                                              #
# Module:                                                                      #
...
################################################################################
# Retrieve learned information on first port
################################################################################
...
foreach stp_intf $bridge_interface_handles {
    ...
    set stat_list [keylget stp_info $port_0.$bridge_handle.stp_intf.$stp_intf]
...
puts "BPDUs Rx: [keylget stp_info $port_0.aggregate.stp_bpdus_rx]"
puts "BPDUs Tx: [keylget stp_info $port_0.aggregate.stp_bpdus_tx]"
