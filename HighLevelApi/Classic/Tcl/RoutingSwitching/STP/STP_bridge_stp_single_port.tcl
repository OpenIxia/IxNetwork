...
set bridge_count            5
set bridge_interface_count  3
set bridge_mac_start        1234.5678.9abc
set bridge_mac_step         0000.0000.0005
set root_mac                0101.0000.1010
...
set stp_status [::ixia::emulation_stp_bridge_config         \
        ...
        -auto_pick_port             0                       \
        -bridge_mac                 $bridge_mac_start       \
        -bridge_mac_step            $bridge_mac_step        \
        -bridge_mode                stp                     \
        -bridge_priority            8192                    \
        -bridge_system_id           113                     \
        -root_mac                   $root_mac               \
        -root_priority              28672                   \
        -root_system_id             431                     \
        -count                      $bridge_count           \
        ...
        -inter_bdpu_gap             100                     \
        -intf_cost                  7                       \
        -intf_count                 $bridge_interface_count \
