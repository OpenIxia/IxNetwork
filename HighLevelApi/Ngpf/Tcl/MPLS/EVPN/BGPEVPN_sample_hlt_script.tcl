...
#                                                                              #
# Description:                                                                 #
#    This script intends to demonstrate how to use NGPF BGP EVPN HLAPI.        #
#                                                                              #
...
set bgp_i_pv4_evpn_evi_1_status [::ixiangpf::emulation_bgp_route_config \
    -handle      $bgpIpv4Peer_1_handle      \
    -mode        create                     \
    -evpn        1                          \
]
if {[keylget bgp_i_pv4_evpn_evi_1_status status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget bgp_i_pv4_evpn_evi_1_status log]"
    return 0
}
set bgpIPv4EvpnEvi_1_handle [keylget bgp_i_pv4_evpn_evi_1_status evpn_evi]
...
set bgpIPv4EvpnEvi_2_status_modify [::ixiangpf::emulation_bgp_route_config \
    -handle                                           $bgpIpv4Peer_1_handle             \
    -mode                                             modify                            \
    -active                                           1                                 \
    -origin                                           igp                               \
...
if {[keylget bgpIPv4EvpnEvi_2_status_modify status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget bgpIPv4EvpnEvi_2_status_modify log]"
    return 0
}
...
set bgp_i_pv4_evpn_evi_3_status [::ixiangpf::emulation_bgp_route_config \
    -handle      $bgpIpv4Peer_2_handle      \
    -mode        create                     \
    -evpn        1                          \
]
if {[keylget bgp_i_pv4_evpn_evi_3_status status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget bgp_i_pv4_evpn_evi_3_status log]"
    return 0
}
set bgpIPv4EvpnEvi_3_handle [keylget bgp_i_pv4_evpn_evi_3_status evpn_evi]
...
# Configure EVI parameters
puts "Configure EVI parameters"
set bgpIPv4EvpnEvi_4_status_modify [::ixiangpf::emulation_bgp_route_config \
    -handle                                           $bgpIpv4Peer_2_handle             \
    -mode                                             modify                            \
    -active                                           1                                 \
    -evpn                                             1                                 \
...
if {[keylget bgpIPv4EvpnEvi_4_status_modify status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget bgpIPv4EvpnEvi_4_status_modify log]"
    return 0
}
