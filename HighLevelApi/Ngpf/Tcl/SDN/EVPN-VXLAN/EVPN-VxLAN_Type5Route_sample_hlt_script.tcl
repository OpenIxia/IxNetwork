...
################################################################################
# Configure EVPN Topologies in both ports as described in Description Section  #
#  above.                                                                      #
################################################################################ 
...
set network_group_4_status [::ixiangpf::network_group_config \
    ...
    -mac_pools_mac                         22.22.22.22.22.22               \
...
set ipv4PrefixPools_3_handle [keylget network_group_6_status ipv4_prefix_pools_handle]
set networkGroup_6_handle [keylget network_group_6_status network_group_handle]

set network_group_16_status [::ixiangpf::emulation_bgp_route_config \
...
if {[keylget network_group_16_status status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget network_group_16_status log]"
    return 0
}
...
set ipv4PrefixPools_3_handle [keylget network_group_7_status ipv4_prefix_pools_handle]
set networkGroup_7_handle [keylget network_group_7_status network_group_handle]

# Configuring OSPF Prefix Pool Parameters
puts "Configuring OSPF Prefix Pool Parameters"
set network_group_8_status [::ixiangpf::emulation_ospf_network_group_config \
...
# Adding multivalue_39 to configure -ad_route_labels
...
# Adding multivalue_40 to configure -upstream_downstream_assigned_mpls_label
...
set macPools_2_handle [keylget network_group_9_status mac_pools_handle]
set ipv4PrefixPools_4_handle [keylget network_group_9_status ipv4_prefix_pools_handle]
set networkGroup_9_handle [keylget network_group_9_status network_group_handle]

# Configure BGP properties in MAC Pool
puts "Configure BGP properties in MAC Pool"
set network_group_10_status [::ixiangpf::emulation_bgp_route_config \
...
if {[keylget network_group_10_status status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget network_group_10_status log]"
    return 0
}

set network_group_11_status [::ixiangpf::network_group_config \
...
if {[keylget network_group_11_status status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget network_group_11_status log]"
    return 0
}
set ipv4PrefixPools_6_handle [keylget network_group_11_status ipv4_prefix_pools_handle]
set networkGroup_11_handle [keylget network_group_11_status network_group_handle]

set network_group_12_status [::ixiangpf::emulation_bgp_route_config \
    -handle                                   $networkGroup_11_handle      \
    -mode                                     create                       \
    -active                                   1                            \
    -max_route_ranges                         1                            \
    -label_step                               1                            \
...
if {[keylget network_group_12_status status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget network_group_12_status log]"
    return 0
}
...
############################################################################
# On The Fly disable/enable BGP EVPN IPv4 Prefix Range                     #
############################################################################
puts "On The Fly disable BGP EVPN IPv4 Prefix Range..."
#(handle : user needs to create and provide handle for cMacProperties, as scriptgen does not return this handle by default)
set disable_prefix [::ixiangpf::emulation_bgp_route_config \
...
if {[keylget disable_prefix status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget disable_prefix log]"
    return 0
}
...
puts "On The Fly enable BGP EVPN IPv4 Prefix Range..."
#(handle : user needs to create and provide handle for cMacProperties, as scriptgen does not return this handle by default)
set enable_prefix [::ixiangpf::emulation_bgp_route_config \
  -handle /topology:1/deviceGroup:1/networkGroup:1/deviceGroup:1/networkGroup:1/networkGroup:1/ipv4PrefixPools:1/evpnIPv4PrefixRange:1 \
  -mode enable\
]
if {[keylget enable_prefix status] != $::SUCCESS} {
    puts "FAIL - $test_name - [keylget enable_prefix log]"
    return 0
}
...
set _result_ [::ixia::traffic_config \
    ...
    -endpointset_count                        1                               \
    -emulation_src_handle                     [list $networkGroup_6_handle]   \
    -emulation_dst_handle                     [list $networkGroup_11_handle]  \
