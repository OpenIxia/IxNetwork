    ...
    "topology": [
	{
	    ...
	    "deviceGroup": [
		{
		    ...
		    "ethernet": [
			{
			    ...
			    "ipv4": [
				{
					...
					{
					    "name": "VTEP-1",
					    "vtepVni": {"start": "1008", "direction": "increment", "step": 2},
					    "vtepIpv4Multicast": {"start": "225.8.0.1", "direction": "increment", "step": "0.0.0.1"}
					}
				    ]
				}
			    ]
	    ...
	    "deviceGroup": [
		{
		    ...
		    "deviceGroup": [
			{
				...
				{
				    "name": "Ethernet-2-2",
				    "macAddress": {"start": "00:01:21:00:00:01", "direction": "increment", "step": "00:00:00:00:00:01", "portStep": "disabled"},
				    "vlanId": {"start": 101, "direction": "increment", "step": 0},
				    "ipv4": [
					{
					    "name": "ipv4-2",
					    "address": {"start": "10.1.1.3", "direction": "increment", "step": "0.0.0.1", "portStep": "disabled"},
					    "gateway": {"start": "10.1.1.1", "direction": "increment", "step": "0.0.0.1", "portStep": "disabled"},
					    "prefix": 24
					}
				    ]
				}
