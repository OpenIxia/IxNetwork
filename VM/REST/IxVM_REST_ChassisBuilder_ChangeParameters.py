...
#    - Changes various card information                                        #
#          - Keep Alive                                                        #
#          - Management IP                                                     #
#    - Changes various port information                                        #
#          - Promiscuous mode                                                  #
#          - MTU                                                               #
#                                                                              #
################################################################################
...
RestCB.create_toplogy(sessionUrl,py.IP_list,2,2)
...
port1_list = RestCB.ixNetGetList(card1_Url,'ixVmPort')
port1_1_Url = sessionUrl.split('/api')[0]+str(port1_list[0]['links'][-1]['href'])
port1_2_Url = sessionUrl.split('/api')[0]+str(port1_list[1]['links'][-1]['href'])

port2_list = RestCB.ixNetGetList(card2_Url,'ixVmPort')
port2_1_Url = sessionUrl.split('/api')[0]+str(port2_list[0]['links'][-1]['href'])
port2_2_Url = sessionUrl.split('/api')[0]+str(port2_list[1]['links'][-1]['href'])

print ("")
print ("card1_Url = " + str(card1_Url))
print (" -> port1_1_Url = " + str(port1_1_Url))
print (" -> port1_2_Url = " + str(port1_2_Url))
print ("card2_Url = " + str(card2_Url))
print (" -> port2_1_Url = " + str(port2_1_Url))
print (" -> port2_2_Url = " + str(port2_2_Url))
print ("")

print ("")
print (" * Change - Card1 - KeepAlive")
print ("")
attribute = {"keepAliveTimeout":"400"}
aaa = ixNetSetAttFromSession(card1_Url, "", attribute)
print (aaa)

print ("")
print (" * Change - Card1 - managementIp")
print ("")
attribute = {"managementIp":"10.0.0.7"}
aaa = ixNetSetAttFromSession(card1_Url, "", attribute)
print (aaa)

print ("")
print (" * Change - Port1_1 - promiscMode")
print ("")
attribute = {"promiscMode":"true" , "interface":"eth1"}
aaa = ixNetSetAttFromSession(port1_1_Url, "", attribute)
print (aaa)

print ("")
print (" * Change - Card2 - KeepAlive")
print ("")
attribute = {"keepAliveTimeout":"500"}
aaa = ixNetSetAttFromSession(card2_Url, "", attribute)
print (aaa)

print ("")
print (" * Change - Port2_1 - mtu")
print ("")
attribute = {"mtu":"9000"}
aaa = ixNetSetAttFromSession(port2_1_Url, "", attribute)
print (aaa)
...
print ("# Test PASS ")
print ("#######################################################")
##raise TestFailedError("STOP HERE")
